...
// Water theme palette (shared with OrderPage)
const colors = {
  primary: "#00A9FF",
  deep: "#0077B6",
  secondary: "#89CFF3",
    ...
    >
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          {/* Header */}
          <div
            className="py-8 px-8 text-white"
          ...
          >
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="font-light mt-2" style={{ opacity: 0.85 }}>
                  Complete your purchase with confidence
                </p>
              </div>
              <div className="text-right">
                <p className="font-light" style={{ opacity: 0.8 }}>Order Total</p>
          ...
          <div className="p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                <div className="flex items-center mb-8">
                  <div
                    className="w-10 h-10 rounded-full text-white flex items-center justify-center font-light mr-4"
                    style={{ backgroundColor: colors.primary }}
                  >
                    1
                  </div>
                  <h3 className="text-2xl font-light tracking-wide" style={{ color: colors.text }}>
                    Delivery formData
                  </h3>
                </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    <label className="flex items-center gap-4 cursor-pointer">
                      ...
                      <div className="flex-1">
                        <span className="text-lg font-medium" style={{ color: colors.text }}>Online Payment</span>
                        <p className="text-sm mt-1" style={{ color: colors.text, opacity: 0.6 }}>
                          UPI, Cards, Net Banking via Razorpay
                        </p>
                      </div>
                      <div className="w-16 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: colors.accent }}>
                ...
                {/* Order Summary */}
                <div className="mt-12 p-6 rounded-2xl border" style={{ backgroundColor: `${colors.background}60`, borderColor: colors.accent }}>
                  <h4 className="text-lg font-medium mb-4 font-light tracking-wide" style={{ color: colors.text }}>
                    Order Summary
                  </h4>
                  <div className="space-y-3">
                    <div className="flex justify-between" style={{ color: colors.text, opacity: 0.7 }}>
                    ...
                    <div className="border-t pt-3 mt-3" style={{ borderColor: colors.accent }}>
                      <div className="flex justify-between text-lg font-medium" style={{ color: colors.text }}>
            ...
            {/* Place Order Button */}
            <div className="mt-12 pt-8 border-t" style={{ borderColor: colors.accent }}>
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className={`px-12 py-4 text-white rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl font-light tracking-wider text-lg ${isPlacingOrder || (Object.keys(touchedFields).length > 0 && !isAddressValid())
