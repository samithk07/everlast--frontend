...
import { authService, getErrorMessage } from "../api/api";
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // TODO: Verify with backend — expects { token, user } from
      // POST /auth/login. See src/api/api.js authService.login.
      ...
      toast.success(
        `Welcome back, ${userData.name || userData.username || userData.email}!`
      );
